classdef SAMOEATL2M < ALGORITHM
    ...
    %------------------------------- Reference --------------------------------
    % Y. Liu, J. Ding, Q. Li, F. Li, J. Liu, A Two-Level Model Management-Based Surrogate-Assisted Evolutionary Algorithm for
    %Medium-Scale Expensive Multiobjective Optimization. IEEE Transactions on Systems, Man, and Cybernetics: Systems,
    %vol. 55, no. 11, pp. 8166-8180, Nov. 2025, doi: 10.1109/TSMC.2025.3604949.
    methods
            ...
            while Algorithm.NotTerminated(A2)
                ...
                while w <= G
                    ...
                    for i = 1:nobj
                        ...
                        y=RBF(OffDec, Model{i}, TestSamNum);
                        OffObj(:,i)=y;
                    end
